...
<body>
	...
	<div class="container">
		...
		<div class="col-md-4 col-xs-6">
		    <div class="shop">
		        <div class="shop-img">
                            <img src="./img/ATTWNN0021.png" alt="">
			</div>
			<div class="shop-body">
			    <h3>Agatha Christie<br>Collection</h3>
			    <a href="aubook?authorId=AGTCRTE001" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		    </div>
		</div>
		<!-- /shop -->
		...
		<div class="col-md-4 col-xs-6">
		    <div class="shop">
			<div class="shop-img">
                            <img src="./img/LRDRNG0012.png" alt="">
			</div>
			<div class="shop-body">
                            <h3>J. R. R Tolkien<br>Collection</h3>
			    <a href="aubook?authorId=JRRTKEN001" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		    </div>
		</div>
		<!-- /shop -->
		...
		<div class="col-md-4 col-xs-6">
		    <div class="shop">
			<div class="shop-img">
                            <img src="./img/HWMVCS0010.png" alt="">
		        </div>
			<div class="shop-body">
                            <h3>Diana Wynne Jones<br>Collection</h3>
			    <a href="aubook?authorId=DNWNJHN001" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		    </div>
		</div>
		<!-- /shop -->
		...
		<div class="col-md-12">
			...
			<div class="products-tabs">
				...
				<div class="products-slick" data-nav="#slick-nav-1">
                            ...
                            <!--Quantity-->     <input name="quantity" value="1" hidden>
